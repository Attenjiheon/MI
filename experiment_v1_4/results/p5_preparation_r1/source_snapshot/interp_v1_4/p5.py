...
CONTRACT = 'experiment_v1_4/p5_r1/contract.json'
...
def verify(root):
    ...
    if config['schema'] != 'p5-read-v1.4-r1': raise ValueError('Unsupported P5 contract')
    return config
...
def export(output, archive):
    ...
    with zipfile.ZipFile(archive,'x',zipfile.ZIP_DEFLATED,compresslevel=1,allowZip64=True) as z:
        ...
        z.writestr('return_manifest.json',json.dumps(dict(schema='p5-return-v1.4-r1',files=files)))
