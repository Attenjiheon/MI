"""Frozen v1.4 decoder-only transformer with named intervention points."""
...
ARCHITECTURES = {
    "deepwide12": Architecture("deepwide12", 12, 256, 4, 1024),
}
...
class Transformer(nn.Module):
    def __init__(self, architecture="deepwide12"):
        super().__init__()
