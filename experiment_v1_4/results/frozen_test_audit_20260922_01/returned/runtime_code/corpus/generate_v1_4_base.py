"""Versioned v1.4 Builder snapshot; seed metadata uses the actual v1.4 RNG.

Do not use this module's inherited v1.0 command-line orchestration. The only
supported entry point is scripts/generate_v1_4_corpus.py.
"""
import argparse
...
import platform
import numpy as np
from .language import (VOCAB, OPS, PATTERNS, MASTER, digest, execute, sample,
                       render, pattern_ok, select_target, all_commands)
from .v1_4 import seed
